...
const AboutMe = ()=>{
    ...
    >
        <div data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in" style={{ display:"flex", flexDirection:"Column"}} >
         
        <Heading fontSize={{base:'1rem',md:'3rem'}} alignSelf={'center'} marginBottom={2}>About Me</Heading>
        <Text fontWeight={300} fontSize={{base:'0.8rem',md:'1.5rem'}}>
